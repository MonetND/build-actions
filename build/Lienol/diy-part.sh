...
export Customized_Information="$(莫奈和 TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
...
git clone --depth=1 https://github.com/douglarek/luci-app-homeproxy.git luci-app-homeproxy
